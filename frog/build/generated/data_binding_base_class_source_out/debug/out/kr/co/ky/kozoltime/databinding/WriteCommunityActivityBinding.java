...
public final class WriteCommunityActivityBinding implements ViewBinding {
  ...
  @NonNull
  public final Spinner ssulSpinner;
  ...
  public static WriteCommunityActivityBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.ssul_spinner;
      Spinner ssulSpinner = ViewBindings.findChildViewById(rootView, id);
      if (ssulSpinner == null) {
        break missingId;
      }

      return new WriteCommunityActivityBinding((LinearLayout) rootView, communityBtn,
          communitySsulContext, communitySsulImage, communitySsulTitle, ssulSpinner);
    }
